...
if (true)
  ...
  pcl::visualization::PointCloudColorHandlerCustom<PointTypeColor> point_cloud_color_handler (point_cloud_ptr, 0, 0, 0);
  ...
  //--------------------
  cv::Mat image;
  while (!viewer.wasStopped () || !mesh_viewer.wasStopped())
  {
